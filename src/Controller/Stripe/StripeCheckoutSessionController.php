...
class StripeCheckoutSessionController extends AbstractController
{
     ...
     */
    public function index(?Cart $cart, OrderServices $orderServices): Response // le ? veut dire que s'il n'arrive pas à recuperer le panier grace au Parameter Converter , il renvoie NULL
    {
       $user = $this->getUser();
        ...
        $orderServices->createOrder($cart); //Nous alllons enregistrer la commande
